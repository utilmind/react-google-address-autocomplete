...
echo Build, format, test, lint, and pack
echo ========================================
echo.
...
echo.
echo [5/8] Building workspace...
call pnpm build
if errorlevel 1 goto :fail

echo.
echo [6/8] Running lint...
call pnpm lint
if errorlevel 1 goto :fail

echo.
echo [7/8] Preparing local package folder...
if not exist "vendor\npm" mkdir "vendor\npm"
if errorlevel 1 goto :fail
...
echo.
echo [8/8] Packing react-google-address-autocomplete...
